...
execute if score rng nem_num matches 9 at @e[tag=nemesis] run summon minecraft:phantom ~ ~ ~ {CustomName:"\"Invisible Phantom\"",PersistenceRequired:1b,Attributes:[{Name:"generic.followRange",Base:64}],Silent:1,ActiveEffects:[{Id:14,Amplifier:0,Duration:2147483647,ShowParticles:0b}]}
execute if score rng nem_num matches 9 at @e[tag=nemesis] run summon minecraft:phantom ~ ~ ~ {CustomName:"\"Invisible Phantom\"",PersistenceRequired:1b,Attributes:[{Name:"generic.followRange",Base:64}],Silent:1,ActiveEffects:[{Id:14,Amplifier:0,Duration:2147483647,ShowParticles:0b}]}
execute if score rng nem_num matches 10 at @e[tag=nemesis] run summon minecraft:phantom ~ ~ ~ {CustomName:"\"Phantom King\"",PersistenceRequired:1b,Silent:1,Size:20,Health:60,Attributes:[{Name:"generic.followRange",Base:64},{Name:"generic.maxHealth",Base:60},{Name:"generic.attackDamage",Base:8}]}
