...
execute if score rng nem_num matches 1 at @e[tag=nemesis] run summon minecraft:ghast ~ ~ ~ {CustomName:"\"the abundant\"",PersistenceRequired:1b,Attributes:[{Name:"generic.followRange",Base:64}]}
execute if score rng nem_num matches 1 at @e[tag=nemesis] run summon minecraft:ghast ~ ~ ~ {CustomName:"\"the abundant\"",PersistenceRequired:1b,Attributes:[{Name:"generic.followRange",Base:64}]}
execute if score rng nem_num matches 2 at @e[tag=nemesis] run summon minecraft:ghast ~ ~ ~ {CustomName:"\"the undetectable\"",PersistenceRequired:1b,Attributes:[{Name:"generic.followRange",Base:64},{Name:"generic.knockbackResistance",Base:1f}],ActiveEffects:[{Id:14,Amplifier:0,Duration:2147483647}]}
