...
execute if score rng nem_num matches 0 at @e[tag=nemesis] run summon minecraft:slime ~ ~ ~ {CustomName:"\"Stacked Slime\"",PersistenceRequired:1b,Size:2,Attributes:[{Name:"generic.followRange",Base:64}],Passengers:[{id:"minecraft:slime",PersistenceRequired:1b,Size:1,Attributes:[{Name:"generic.followRange",Base:64}]},{id:"minecraft:slime",PersistenceRequired:1b,Size:1,Attributes:[{Name:"generic.followRange",Base:64}]},{id:"minecraft:slime",PersistenceRequired:1b,Size:1,Attributes:[{Name:"generic.followRange",Base:64}]},{id:"minecraft:slime",PersistenceRequired:1b,Size:1,Attributes:[{Name:"generic.followRange",Base:64}]}]}
execute if score rng nem_num matches 1 at @e[tag=nemesis] run summon minecraft:slime ~ ~ ~ {CustomName:"\"Big Slime\"",PersistenceRequired:1b,Size:9,Attributes:[{Name:"generic.followRange",Base:64}]}
