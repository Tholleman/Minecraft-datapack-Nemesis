...
execute if score rng nem_num matches 3 run summon minecraft:creeper ~ ~ ~ {CustomName:"\"Missle\"",PersistenceRequired:1b,Fire:1277951,Attributes:[{Name:"generic.maxHealth",Base:10},{Name:"generic.followRange",Base:64},{Name:"generic.movementSpeed",Base:0.5f}],Fuse:10,ActiveEffects:[{Id:12,Amplifier:0,Duration:2147483647}]}
execute if score rng nem_num matches 3 run summon minecraft:creeper ~ ~ ~ {CustomName:"\"Missle\"",PersistenceRequired:1b,Fire:1277951,Attributes:[{Name:"generic.maxHealth",Base:10},{Name:"generic.followRange",Base:64},{Name:"generic.movementSpeed",Base:0.5f}],Fuse:10,ActiveEffects:[{Id:12,Amplifier:0,Duration:2147483647}]}
execute if score rng nem_num matches 3 run summon minecraft:creeper ~ ~ ~ {CustomName:"\"Missle\"",PersistenceRequired:1b,Fire:1277951,Attributes:[{Name:"generic.maxHealth",Base:10},{Name:"generic.followRange",Base:64},{Name:"generic.movementSpeed",Base:0.5f}],Fuse:10,ActiveEffects:[{Id:12,Amplifier:0,Duration:2147483647}]}
