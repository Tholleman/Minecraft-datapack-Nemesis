...
execute if score rng nem_num matches 2 at @e[tag=nemesis] run summon minecraft:vindicator ~ ~ ~ {PersistenceRequired:1b,CanPickUpLoot:1b,Attributes:[{Name:"generic.followRange",Base:64}],HandItems:[{id:"minecraft:iron_axe",Count:1},{}]}
execute if score rng nem_num matches 3 at @e[tag=nemesis] run summon minecraft:vindicator ~ ~ ~ {PersistenceRequired:1b,CanPickUpLoot:1b,Fire:1277951,Attributes:[{Name:"generic.followRange",Base:64}],Silent:1,HandItems:[{id:"minecraft:golden_axe",tag:{Enchantments:[{id:fire_aspect,lvl:2}]},Count:1},{}],ActiveEffects:[{Id:12,Amplifier:0,Duration:2147483647,ShowParticles:0b},{Id:14,Amplifier:0,Duration:2147483647,ShowParticles:0b}]}
