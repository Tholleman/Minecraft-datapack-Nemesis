...
execute if score rng nem_num matches 3 at @e[tag=nemesis] run summon minecraft:wither_skeleton ~ ~ ~ {CustomName:"\"Captain-General\"",PersistenceRequired:1b,Health:50,Attributes:[{Name:"generic.followRange",Base:64},{Name:"generic.maxHealth",Base:50},{Name:"generic.knockbackResistance",Base:0.8f}],HandItems:[{id:"minecraft:diamond_sword",Count:1},{}],HandDropChances:[0F,0F],ArmorItems:[{id:"minecraft:diamond_boots",Count:1},{id:"minecraft:diamond_leggings",Count:1},{id:"minecraft:diamond_chestplate",Count:1},{id:"minecraft:wither_skeleton_skull",Count:1}],ArmorDropChances:[0F,0F,0F,0F]}
