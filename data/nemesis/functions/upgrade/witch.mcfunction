...
execute if score rng nem_num matches 5 at @e[tag=nemesis] run summon minecraft:witch ~ ~ ~ {PersistenceRequired:1b,CanPickUpLoot:1b,Attributes:[{Name:"generic.followRange",Base:64}],Passengers:[{id:"minecraft:potion",Potion:{id:"minecraft:lingering_potion",Count:1,tag:{CustomPotionEffects:[{Id:9,Amplifier:0,Duration:300}]}}}]}
execute if score rng nem_num matches 3 at @e[tag=nemesis] run summon minecraft:witch ~ ~ ~ {PersistenceRequired:1b,CanPickUpLoot:1b,Attributes:[{Name:"generic.followRange",Base:64}],Passengers:[{id:"minecraft:potion",Potion:{id:"minecraft:lingering_potion",Count:1,tag:{CustomPotionEffects:[{Id:2,Amplifier:4,Duration:600}]}}}]}
...
execute if score rng nem_num matches 8 at @e[tag=nemesis] run summon minecraft:witch ~ ~ ~ {PersistenceRequired:1b,CanPickUpLoot:1b,Attributes:[{Name:"generic.followRange",Base:64}],Passengers:[{id:"minecraft:potion",Potion:{id:"minecraft:lingering_potion",Count:1,tag:{CustomPotionEffects:[{Id:18,Amplifier:1,Duration:600}]}}}]}
...
execute if score rng nem_num matches 8 at @e[tag=nemesis] run summon minecraft:witch ~ ~ ~ {PersistenceRequired:1b,CanPickUpLoot:1b,Attributes:[{Name:"generic.followRange",Base:64}],Passengers:[{id:"minecraft:potion",Potion:{id:"minecraft:lingering_potion",Count:1,tag:{CustomPotionEffects:[{Id:9,Amplifier:0,Duration:300}]}}}]}
execute if score rng nem_num matches 8 at @e[tag=nemesis] run summon minecraft:witch ~ ~ ~ {PersistenceRequired:1b,CanPickUpLoot:1b,Attributes:[{Name:"generic.followRange",Base:64}],Passengers:[{id:"minecraft:potion",Potion:{id:"minecraft:lingering_potion",Count:1,tag:{CustomPotionEffects:[{Id:2,Amplifier:4,Duration:600}]}}}]}
execute if score rng nem_num matches 8 at @e[tag=nemesis] run summon minecraft:witch ~ ~ ~ {PersistenceRequired:1b,CanPickUpLoot:1b,Attributes:[{Name:"generic.followRange",Base:64}],Passengers:[{id:"minecraft:potion",Potion:{id:"minecraft:lingering_potion",Count:1,tag:{CustomPotionEffects:[{Id:15,Amplifier:0,Duration:600}]}}}]}
