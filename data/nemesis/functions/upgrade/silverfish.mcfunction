...
execute if score rng nem_num matches 2 at @e[tag=nemesis] run summon minecraft:silverfish ~ ~ ~ {CustomName:"\"an infestation of Silverfish\"",PersistenceRequired:1b,Health:40,Attributes:[{Name:"generic.maxHealth",Base:40},{Name:"generic.followRange",Base:64}]}
execute if score rng nem_num matches 2 at @e[tag=nemesis] run summon minecraft:silverfish ~ ~ ~ {CustomName:"\"an infestation of Silverfish\"",PersistenceRequired:1b,Health:40,Attributes:[{Name:"generic.maxHealth",Base:40},{Name:"generic.followRange",Base:64}]}
execute if score rng nem_num matches 2 at @e[tag=nemesis] run summon minecraft:silverfish ~ ~ ~ {CustomName:"\"an infestation of Silverfish\"",PersistenceRequired:1b,Health:40,Attributes:[{Name:"generic.maxHealth",Base:40},{Name:"generic.followRange",Base:64}]}
execute if score rng nem_num matches 2 at @e[tag=nemesis] run summon minecraft:silverfish ~ ~ ~ {CustomName:"\"an infestation of Silverfish\"",PersistenceRequired:1b,Health:40,Attributes:[{Name:"generic.maxHealth",Base:40},{Name:"generic.followRange",Base:64}]}
execute if score rng nem_num matches 2 at @e[tag=nemesis] run summon minecraft:silverfish ~ ~ ~ {CustomName:"\"an infestation of Silverfish\"",PersistenceRequired:1b,Health:40,Attributes:[{Name:"generic.maxHealth",Base:40},{Name:"generic.followRange",Base:64}]}
