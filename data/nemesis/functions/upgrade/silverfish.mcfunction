...
execute if score rng nem_num matches 2 at @e[tag=nemesis] run summon minecraft:silverfish ~ ~ ~ {CustomName:"\"an investation of Silverfish\"",PersistenceRequired:1b,Health:40,Attributes:[{Name:"generic.maxHealth",Base:40},{Name:"generic.followRange",Base:64}]}
execute if score rng nem_num matches 2 at @e[tag=nemesis] run summon minecraft:silverfish ~ ~ ~ {CustomName:"\"an investation of Silverfish\"",PersistenceRequired:1b,Health:40,Attributes:[{Name:"generic.maxHealth",Base:40},{Name:"generic.followRange",Base:64}]}
execute if score rng nem_num matches 2 at @e[tag=nemesis] run summon minecraft:silverfish ~ ~ ~ {CustomName:"\"an investation of Silverfish\"",PersistenceRequired:1b,Health:40,Attributes:[{Name:"generic.maxHealth",Base:40},{Name:"generic.followRange",Base:64}]}
execute if score rng nem_num matches 2 at @e[tag=nemesis] run summon minecraft:silverfish ~ ~ ~ {CustomName:"\"an investation of Silverfish\"",PersistenceRequired:1b,Health:40,Attributes:[{Name:"generic.maxHealth",Base:40},{Name:"generic.followRange",Base:64}]}
execute if score rng nem_num matches 2 at @e[tag=nemesis] run summon minecraft:silverfish ~ ~ ~ {CustomName:"\"an investation of Silverfish\"",PersistenceRequired:1b,Health:40,Attributes:[{Name:"generic.maxHealth",Base:40},{Name:"generic.followRange",Base:64}]}
...
execute if entity @e[tag=nemesis] run scoreboard players add @s[scores={nem_silverfish=..2}] nem_silverfish 1
